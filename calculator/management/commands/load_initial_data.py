...
#   O=Orange, P=Purple, W=White, K=Black, R=Red, G=Green, B=Blue, Y=Yellow,
#   Br=Brown
#
#   NOTE: 'B' always means BLUE across these codes. 'Black' is written as 'K'
#   and 'Brown' as 'Br' to avoid any ambiguity with Blue.
#
#   So 'LDPE B/W' means Blue outside, White inside (no exception needed now —
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        materials_data = [
            ...
            {'name': 'W/K Ldpe', 'code': 'ldpe_w_b_ldpe', 'material_type': 'FILM', 'density': 0.9457,
             'description': 'LDPE two-layer film - White outside, Black (K) inside - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'LDPE coffee brown', 'code': 'ldpe_coffee_brown', 'material_type': 'FILM', 'density': 0.9277,
             'description': 'LDPE - Coffee Brown (Br) (single layer/color) - measured extrusion density', 'is_ldpe': True},
            {'name': 'LDPE black recycle', 'code': 'ldpe_black_recycle', 'material_type': 'FILM', 'density': 0.9302,
             'description': 'LDPE - Black (K), made from recycled material (single layer/color) - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'LDPE B/W', 'code': 'ldpe_b_w', 'material_type': 'FILM', 'density': 0.9355,
             'description': 'LDPE two-layer film - Blue (B) outside, White inside - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'LDPE blue', 'code': 'ldpe_blue', 'material_type': 'FILM', 'density': 0.9304,
             'description': 'LDPE - Blue (B) (single layer/color) - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'LDPE black', 'code': 'ldpe_black', 'material_type': 'FILM', 'density': 0.9179,
             'description': 'LDPE - Black (K) (single layer/color) - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'LDPE Tint blue', 'code': 'ldpe_tint_blue_2', 'material_type': 'FILM', 'density': 0.9214,
             'description': 'LDPE - light/translucent Blue (B) tint (single layer/color) - measured extrusion density', 'is_ldpe': True},
            ...
            {'name': 'HDPE brown', 'code': 'hdpe_brown', 'material_type': 'FILM', 'density': 0.942,
             'description': 'HDPE - Brown (Br) (single layer/color) - measured extrusion density'},
            {'name': 'HDPE coffee brown', 'code': 'hdpe_coffee_brown', 'material_type': 'FILM', 'density': 0.938,
             'description': 'HDPE - Coffee Brown (Br) (single layer/color) - measured extrusion density'},
            ...
            {'name': 'HDPE siege brown', 'code': 'hdpe_siege_brown', 'material_type': 'FILM', 'density': 1.088,
             'description': 'HDPE - Siege Brown (Br), density suggests mineral filler content (unconfirmed) - measured extrusion density'},
            ...
            {'name': 'HDPE tint blue', 'code': 'hdpe_tint_blue', 'material_type': 'FILM', 'density': 1.002,
             'description': 'HDPE - light/translucent Blue (B) tint, density suggests mineral filler content (unconfirmed) - measured extrusion density'},
            ...
            {'name': 'HDPE blue', 'code': 'hdpe_blue', 'material_type': 'FILM', 'density': 1.037,
             'description': 'HDPE - Blue (B), density suggests mineral filler content (unconfirmed) - measured extrusion density'},
            {'name': 'HDPE black', 'code': 'hdpe_black', 'material_type': 'FILM', 'density': 1.005,
             'description': 'HDPE - Black (K), density suggests mineral filler content (unconfirmed) - measured extrusion density'},
            ...
            {'name': 'HDPE Blue', 'code': 'hdpe_blue_2', 'material_type': 'FILM', 'density': 0.9791,
             'description': 'HDPE - Blue (B), compounded with mineral filler (density above unfilled HDPE) - measured extrusion density'},
            ...
            {'name': 'HDPE TInt blue', 'code': 'hdpe_tint_blue_2', 'material_type': 'FILM', 'density': 0.9559,
             'description': 'HDPE - light/translucent Blue (B) tint (single layer/color) - measured extrusion density'},
            ...
            {'name': 'HDPE bLACK', 'code': 'hdpe_black_2', 'material_type': 'FILM', 'density': 0.9367,
             'description': 'HDPE - Black (K) (single layer/color) - measured extrusion density'},
            ...
            {'name': 'HDPE SKY BLUE', 'code': 'hdpe_sky_blue', 'material_type': 'FILM', 'density': 1.0223,
             'description': 'HDPE - Sky Blue (B), compounded with mineral filler (density above unfilled HDPE) - measured extrusion density'},
            {'name': 'HDPE Brown', 'code': 'hdpe_brown_2', 'material_type': 'FILM', 'density': 1.0223,
             'description': 'HDPE - Brown (Br), compounded with mineral filler (density above unfilled HDPE) - measured extrusion density'},
            ...
            {'name': 'UHT/EVOH W/K', 'code': 'evoh_uht_w_b', 'material_type': 'FILM', 'density': 0.9691,
             'description': 'Multilayer barrier film for UHT (Ultra High Temperature/aseptic) packaging, incorporating an EVOH oxygen-barrier layer - White outside, Black (K) inside - measured extrusion density'},
